          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _StatPill(label: '${filtrados.length} total', color: Colors.white24, text: Colors.white70),
                    const SizedBox(width: 8),
                    _StatPill(label: '$activos activos', color: const Color(0xFF10B981).withOpacity(0.25), text: const Color(0xFF6EE7B7)),
                    const SizedBox(width: 8),
                    _StatPill(label: '$inactivos inactivos', color: Colors.white12, text: Colors.white38),
                  ],
                ),
                const SizedBox(height: 12),
                // Search bar
